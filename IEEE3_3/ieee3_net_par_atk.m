...
u=[u1(1),u2(1),u1(2),u2(2),u3(1),u3(2)];
...
%I-Controllable
i_cont=(rank([E zeros(17,17) zeros(17,6);A E B])==rank(E)+size(A,1));
im_cont=(rank([E A B;zeros(17,17) E zeros(17,6)])==rank(E)+rank([E A B]));
...
%Detectibility
dec=(rank([s*E'-A' eye(17)])==size(A,1));

tspan=[0 50];
[P,K,~]=icare(A,B,eye(17),diag([1;1;1;1;5;5]),0,eye(17));
