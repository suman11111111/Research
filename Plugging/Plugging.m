...
for i=1:N
    ...
    w5(i)=b5+2*c5*P5(i)-theta*(1/(P5(i)-Pmin5)-1/(Pmax5-P5(i)));
    w6(i)=b6+2*c6*P6(i)-theta*(1/(P6(i)-Pmin6)-1/(Pmax6-P6(i)));
    w7(i)=b7+2*c7*P7(i)-theta*(1/(P7(i)-Pmin7)-1/(Pmax7-P7(i)));
    
    alpha1(i+1)=alpha1(i)+dt*(3*w1(i)-w2(i)-w6(i)-w7(i))'*(3*w1(i)-w2(i)-w6(i)-w7(i));
    alpha2(i+1)=alpha2(i)+dt*(4*w2(i)-w1(i)-w3(i)-w5(i)-w6(i))'*(4*w2(i)-w1(i)-w3(i)-w5(i)-w6(i));
    alpha3(i+1)=alpha3(i)+dt*(3*w3(i)-w2(i)-w3(i)-w6(i))'*(3*w3(i)-w2(i)-w3(i)-w6(i));
    alpha4(i+1)=alpha4(i)+dt*(3*w4(i)-w3(i)-w5(i)-w7(i))'*(3*w4(i)-w3(i)-w5(i)-w6(i));
    alpha5(i+1)=alpha5(i)+dt*(3*w5(i)-w4(i)-w6(i)-w2(i))'*(3*w5(i)-w4(i)-w6(i)-w2(i));
    alpha6(i+1)=alpha6(i)+dt*(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i))'*(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i));
    alpha7(i+1)=alpha7(i)+dt*(2*w7(i)-w1(i)-w4(i))'*(2*w7(i)-w1(i)-w4(i));
    
    beta1(i+1)=(3*w1(i)-w2(i)-w6(i)-w7(i))'*(3*w1(i)-w2(i)-w6(i)-w7(i));
    beta2(i+1)=(4*w2(i)-w1(i)-w3(i)-w5(i)-w6(i))'*(4*w2(i)-w1(i)-w3(i)-w5(i)-w6(i));
    beta3(i+1)=(3*w3(i)-w2(i)-w4(i)-w6(i))'*(3*w3(i)-w2(i)-w4(i)-w6(i));
    beta4(i+1)=(3*w4(i)-w3(i)-w5(i)-w7(i))'*(3*w4(i)-w3(i)-w5(i)-w7(i));
    beta5(i+1)=(3*w5(i)-w4(i)-w6(i)-w2(i))'*(3*w5(i)-w4(i)-w6(i)-w2(i));
    beta6(i+1)=(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i))'*(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i));
    beta7(i+1)=(2*w7(i)-w1(i)-w4(i))'*(2*w7(i)-w1(i)-w4(i));
    ...
    P5(i+1)=P5(i)+dt*((alpha5(i)+beta5(i))*(-1)*(3*w5(i)-w4(i)-w6(i)-w2(i)));
    P6(i+1)=P6(i)+dt*((alpha6(i)+beta6(i))*(-1)*(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i)));
    P7(i+1)=P7(i)+dt*((alpha7(i)+beta7(i))*(-1)*(2*w7(i)-w1(i)-w4(i)));
    end
end
...
figure();
plot(P1);hold on;plot(P2);plot(P3);plot(P4);plot(P5);plot(P6);plot(P7);
% ax = gca;
% tick_scale_factor =dt;
% ax.XTickLabel = ax.XTick * tick_scale_factor;

figure();
plot(alpha1);hold on;plot(alpha2);plot(alpha3);plot(alpha4);plot(alpha5);plot(alpha6);plot(alpha7);
% ax = gca;
% tick_scale_factor =dt;
% ax.XTickLabel = ax.XTick * tick_scale_factor;

figure();
plot(beta1);hold on;plot(beta2);hold on;plot(beta3);hold on;plot(beta4);hold on;plot(beta5);hold on;plot(beta6);plot(beta7);
% ax = gca;
% tick_scale_factor =dt;
% ax.XTickLabel = ax.XTick * tick_scale_factor;
ylim([0 30])
...
figure();
plot(w1);hold on;plot(w2);hold on;plot(w3);hold on;plot(w4);hold on;plot(w5);hold on;plot(w6);plot(w7);
% ax = gca;
% tick_scale_factor =dt;
% ax.XTickLabel = ax.XTick * tick_scale_factor;
ylim([0 6])