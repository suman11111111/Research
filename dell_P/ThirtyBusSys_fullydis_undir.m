...
P=[1/3 1/3 0 0 0 1/3;1/5 1/5 1/5 0 1/5 1/5;0 1/4 1/4 1/4 0 1/4;0 0 1/3 1/3 1/3 0;0 1/4 0 1/4 1/4 1/4;1/5 1/5 1/5 0 1/5 1/5];
Q=P';
ef=4e-3;
...
if lamda(j,i+1)>lamda_max(j)
    p(j,i+1)=p_max(j);
end

if lamda(j,i+1)<lamda_min(j)
    p(j,i+1)=p_min(j);
end
p(j,i+1)=beta(j,j)*lamda(j,i+1)+alpha(j);
