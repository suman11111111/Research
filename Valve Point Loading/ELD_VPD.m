...
for i=1:N
    ...
    w1(i)=b1+2*c1*P1(i)-theta*(1/(P1(i)-Pmin1)-1/(Pmax1-P1(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
    w2(i)=b2+2*c2*P2(i)-theta*(1/(P2(i)-Pmin2)-1/(Pmax2-P2(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
    w3(i)=b3+2*c3*P3(i)-theta*(1/(P3(i)-Pmin3)-1/(Pmax3-P3(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
    w4(i)=b4+2*c4*P4(i)-theta*(1/(P4(i)-Pmin4)-1/(Pmax4-P4(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
    w5(i)=b5+2*c5*P5(i)-theta*(1/(P5(i)-Pmin5)-1/(Pmax5-P5(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
    w6(i)=b6+2*c6*P6(i)-theta*(1/(P6(i)-Pmin6)-1/(Pmax6-P6(i)))+d1*e1*cos(e1*(Pmin1-P1(i)));
