...
[t,x]=ode23t(@(t,x) des(J,x,F,t,ta_i,ta_f),tspan,xeq,options);

function dae=des(J,x,F,t,ta_i,ta_f)
    if t>=ta_i && t<ta_f
        f=0.2*cos(t)-0.5*sin(2*t);
    else
        f=0;
    end
    dae=J*x+F*f;
...
figure()
plot(t,x(:,1),'r-','LineWidth', 1),hold on,plot(t,x(:,2),'k-','LineWidth', 1)
...
figure()
plot(t,x(:,3),'r-','LineWidth', 1),hold on,plot(t,x(:,4),'k-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
...
figure()
plot(t,x(:,6),'r-','LineWidth', 1),hold on,plot(t,x(:,7),'k-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
...
figure()
plot(t,x(:,8),'r-','LineWidth', 1),hold on,plot(t,x(:,9),'k-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
...
figure()
plot(t,x(:,10),'r-','LineWidth', 1),hold on,plot(t,x(:,11),'k-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
...
figure()
plot(t,x(:,12),'r-','LineWidth', 1),hold on,plot(t,x(:,13),'k-','LineWidth', 1),plot(t,x(:,14),'b-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
...
figure()
plot(t,x(:,15),'r-','LineWidth', 1),hold on,plot(t,x(:,16),'k-','LineWidth', 1),plot(t,x(:,17),'b-','LineWidth', 1)
xlabel('Time t \rightarrow', 'FontSize', 28, 'FontWeight', 'bold')
