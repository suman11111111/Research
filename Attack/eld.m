...
for i=1:N
    ...
    P1(i+1)=P1(i)+dt*((-1)*(2*w1(i)-w2(i)-w6(i)));
    P2(i+1)=P2(i)+dt*((-1)*(4*w2(i)-w1(i)-w3(i)-w5(i)-w6(i)));
    P3(i+1)=P3(i)+dt*((-1)*(3*w3(i)-w2(i)-w4(i)-w6(i)));
    P4(i+1)=P4(i)+dt*((-1)*(2*w4(i)-w3(i)-w5(i)));
    P5(i+1)=P5(i)+dt*((-1)*(3*w5(i)-w4(i)-w6(i)-w2(i)));
    P6(i+1)=P6(i)+dt*((-1)*(4*w6(i)-w1(i)-w2(i)-w3(i)-w5(i)));
end
